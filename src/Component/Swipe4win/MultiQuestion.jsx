...
//   const [dataUpload, dataUploadApi, loading] = useFetch(
//     "https://cmsn.bngrenew.com/cms/cmsUploadAllMultipartFile",
//     {
...
//         <Typography variant="h4" align="center" gutterBottom style={{ fontSize: "24px" }}>
//           Upload Files
//         </Typography>
  ...
  const uploadImages = async (files) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      if (file.size <= 20000) {
        ...
        try {
          const response = POST(API_URLS.dataUpload, formData, {
            headers: {
            ...
            onUploadProgress: (progressEvent) => {
              ...
              setUploadProgress((prevProgress) =>
                prevProgress.map((prev, index) => (index === i ? progressPercentage : prev))
              );
            },
          });
        ...
        errors.push(`Image "${file.name}" exceeds the maximum size of 20KB.`);
      }
    }
