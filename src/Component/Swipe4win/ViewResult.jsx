...
const handleExport=()=>{
  GET(`https://swip4winapiv1.bngrenew.com:5081/swipe4win/cms/report/export/excel?operatorId=zainlibyana_libya&gtDate=${startDate?.toISOString().split("T")[0]}&ltDate=${endDate?.toISOString().split("T")[0]}`).then((res)=>console.log(res)).catch((err)=>console.log(err))
}
  return (
    <div className="mx-4 my-2">
      ...
      {reportData && <TableContainer className={(classes.tableContainer, "mt-20")}>
